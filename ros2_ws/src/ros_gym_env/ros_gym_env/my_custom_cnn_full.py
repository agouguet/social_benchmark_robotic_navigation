...
# #
# class MyCustomCNN(BaseFeaturesExtractor):
...
#         #
#         super(MyCustomCNN, self).__init__(observation_space, features_dim)
#         # define the model
#         #
#         ################## ped_pos net model: ###################
#         if norm_layer is None:
...
#         ###### Start of fusion net ######
#         fusion_in = scan.reshape(-1,1,80,80)
...
#         # preprocessing:
#         scan = observations[:, :6400]   # 1 x 80 x 80 = 6400
#         goal = observations[:, 6400:]   # 2 valeurs
...
class Scan1DCNN(BaseFeaturesExtractor):
    def __init__(self, observation_space: gym.spaces.Box, features_dim: int = 256):
        ...
        # Observation: 6400 (scan) + 2 (goal) = 6402
        # self.scan_dim = 6400
        self.scan_dim = 720
        goal_dim = observation_space.shape[0] - self.scan_dim  # expected to be 2
