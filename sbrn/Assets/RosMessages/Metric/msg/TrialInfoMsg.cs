...
namespace RosMessageTypes.Metric
{
    [Serializable]
    public class TrialInfoMsg : Message
    {
        public const string k_RosMessageName = "metric_msgs/TrialInfo";
        ...
        public double minimum_time_to_collision;
        public double movement_jerk;
        ...
        public TrialInfoMsg(Std.HeaderMsg header, BuiltinInterfaces.TimeMsg trial_start, double timeout_time, string trial_name, ushort trial_number, uint num_actors, Geometry.PoseMsg robot_start, Geometry.PoseMsg robot_goal, double dist_to_target, double min_dist_to_target, Geometry.PoseMsg[] robot_poses, BuiltinInterfaces.TimeMsg[] robot_poses_ts, double min_dist_to_ped, uint robot_on_person_intimate_dist_violations, uint person_on_robot_intimate_dist_violations, uint robot_on_person_personal_dist_violations, uint person_on_robot_personal_dist_violations, uint robot_on_person_collisions, uint person_on_robot_collisions, uint obj_collisions, double path_length, double path_irregularity, double time_not_moving, double time_in_personal_space, double minimum_time_to_collision, double movement_jerk)
        {
            ...
            this.minimum_time_to_collision = minimum_time_to_collision;
            this.movement_jerk = movement_jerk;
        }
        ...
        private TrialInfoMsg(MessageDeserializer deserializer)
        {
            ...
            deserializer.Read(out this.minimum_time_to_collision);
            deserializer.Read(out this.movement_jerk);
        }
        ...
        public override void SerializeTo(MessageSerializer serializer)
        {
            ...
            serializer.Write(this.minimum_time_to_collision);
            serializer.Write(this.movement_jerk);
        }
        ...
        public override string ToString()
        {
            ...
            "\nminimum_time_to_collision: " + minimum_time_to_collision.ToString() +
            "\nmovement_jerk: " + movement_jerk.ToString();
        }
