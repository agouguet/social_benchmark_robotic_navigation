...
namespace RosMessageTypes.Rosgraph
{
    public class MTopicStatistics : Message
    {
        ...
        public MTopicStatistics(string topic, string node_pub, string node_sub, TimeMsg window_start, TimeMsg window_stop, int delivered_msgs, int dropped_msgs, int traffic, MDuration period_mean, MDuration period_stddev, MDuration period_max, MDuration stamp_age_mean, MDuration stamp_age_stddev, MDuration stamp_age_max)
        {
            this.topic = topic;
