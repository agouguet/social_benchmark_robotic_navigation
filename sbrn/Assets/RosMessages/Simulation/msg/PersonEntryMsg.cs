...
namespace RosMessageTypes.Simulation
{
    ...
    {
        public const string k_RosMessageName = "simulation_msgs/PersonEntry";
        ...
        public PersonEntryMsg(Std.HeaderMsg header, ulong track_id, Geometry.PoseMsg pose, Geometry.TwistMsg twist)
        {
            this.header = header;
