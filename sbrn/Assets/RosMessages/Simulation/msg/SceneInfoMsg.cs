...
namespace RosMessageTypes.Simulation
{
    ...
    {
        public const string k_RosMessageName = "simulation_msgs/SceneInfo";
        ...
        public SceneInfoMsg(Std.HeaderMsg header, string scenario_name, Geometry.PoseMsg robot_start_pose, Geometry.PoseMsg robot_target_pose, ushort num_people, ushort num_groups, string environment)
        {
            this.header = header;
