...
namespace RosMessageTypes.SocialSimRos
{
    ...
    public class TrialInfoMsg : Message
    {
        ...
        public TrialInfoMsg()
        {
            ...
            this.robot_poses_ts = new TimeMsg[0];
        ...
        private TrialInfoMsg(MessageDeserializer deserializer)
        {
            ...
            this.trial_start = TimeMsg.Deserialize(deserializer);
            ...
            deserializer.Read(out this.robot_poses_ts, TimeMsg.Deserialize, deserializer.ReadLength());
