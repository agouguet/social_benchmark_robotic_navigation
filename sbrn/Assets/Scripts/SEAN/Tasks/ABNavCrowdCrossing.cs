...
{
    public class ABNavCrowdCrossing : Base
    {
        ...
        protected override bool NewTask()
        {
            ...
            Scenario.PedestrianBehavior.CrowdCrossing scenario = (Scenario.PedestrianBehavior.CrowdCrossing)sean.pedestrianBehavior;
