...
namespace SEAN.Input
{
    public class InputPublisher : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            ros.RegisterPublisher<RosMessageTypes.Std.BoolMsg>(TopicCmdVel);
            ros.RegisterPublisher<RosMessageTypes.Geometry.TwistMsg>(TopicTrigger);
        ...
        public RosMessageTypes.Geometry.TwistMsg CmdVel
        {
            get
            {
                // cmd vel
        ...
        {
            // trigger
            RosMessageTypes.Std.BoolMsg b = new RosMessageTypes.Std.BoolMsg();
            b.data = L1;
            ros.Publish(TopicTrigger, b);
            // cmd vel
            ros.Publish(TopicCmdVel, CmdVel);
        }
    }
}
